...
if "%1" == "__start__" (
    ...
    cmd /k "cd /d C:\Users\pablo\Desktop\Pablo\Proyectos Python\Probando Django\mongodb_app\appvenv\Scripts & activate  & cd C:\Users\pablo\Desktop\Pablo\Proyectos Python\Probando Django\mongodb_app & python main.py %* & deactivate"
)